            ...
            <div class="flex flex-row">
                ...
                <form action="{{ route('auth.register') }}" method="POST" >
                    ...
                    <div style="background-color: #fff; padding: 4px 16px; border-radius: 10px;">
                        ...
                        <input type="password" class=" w-full my-2" style="outline-color: rgb(35, 172, 35);border: 1px solid rgba(0,0, 0, 0.4);border-radius: 6px; margin-top: 8px;padding: 3px 8px;" name="password2">
                    </div>  
                    <div style="background-color: #fff; padding: 4px 16px; border-radius: 10px;">
